...
const Pricing = () => {
  return (
    <section className="relative h-auto flex flex-col items-center justify-center text-center bg-gradient-to-br from-gray-700 to-gray-600 text-white overflow-hidden py-10">
      ...
      <div className="relative z-10 w-full max-w-6xl p-6 mt-10 animate-fade-in-up delay-2s">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-gradient-to-br from-blue-600 to-blue-800 text-white rounded-xl shadow-lg p-6 text-center">
            <h3 className="text-2xl font-semibold mb-4">Zdjęcia</h3>
            <p className="text-4xl font-bold mb-4">250 zł</p>
          ...
          <div className="bg-gradient-to-br from-green-600 to-green-800 text-white rounded-xl shadow-lg p-6 text-center">
            <h3 className="text-2xl font-semibold mb-4">Zdjęcia + Opis</h3>
            <p className="text-4xl font-bold mb-4">350 zł</p>
          ...
          <div className="bg-gradient-to-br from-yellow-600 to-yellow-800 text-white rounded-xl shadow-lg p-6 text-center">
            <h3 className="text-2xl font-semibold mb-4">Zdjęcia + Opis + Wystawienie Aukcji</h3>
            <p className="text-4xl font-bold mb-4">550 zł</p>
